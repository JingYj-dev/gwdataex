...
import com.hnjz.apps.base.log.service.OpLogExportService;
...
public class OpLogExport extends AdminAction {
	...
	protected String adminGo() {
		try {
			...
			response.reset();
			this.inputStream = OpLogExportService.exportExcel(page, funcId, operName, operType, 
									      opObjType, beginDate, endDate, this.getFileRealPath() + fileName);
		} catch (Exception e) {
