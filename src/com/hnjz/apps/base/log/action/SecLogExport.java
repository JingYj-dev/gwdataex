...
import com.hnjz.apps.base.log.service.SecLogExportService;
...
public class SecLogExport extends AdminAction {
	...
	protected String adminGo() {
		try {
			...
			response.reset();
			this.inputStream = SecLogExportService.exportExcel(page, funcId, operName, operType, 
