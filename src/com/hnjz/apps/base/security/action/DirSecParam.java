...
public class DirSecParam extends AdminAction {
	private static final long serialVersionUID = -3464653131463418344L;
	private static Log log = LogFactory.getLog(DirSecParam.class);
	...
	public String adminGo() {
		try {
			QueryCache qc = new QueryCache(" select a.paramId from SecParam a " + getWhere() +getOrder());
			setWhere(qc);
			page = qc.page(page);
			page.setResults(QueryCache.idToObj(SecParam.class, page.getResults()));
