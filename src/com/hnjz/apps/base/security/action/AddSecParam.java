...
public class AddSecParam extends AdminAction implements ModelDriven {
	private static final long serialVersionUID = 1L;
	private static Log log = LogFactory.getLog(AddSecParam.class);
	private SecParam item;
	
	
	public AddSecParam() { 
		this.item = new SecParam();
	}
	...
	public Boolean check(SecParam item){
		SecParam sParm = QueryCache.get(SecParam.class, item.getParamId());
		if(sParm == null){
			return true;
		}
		return false;
