...
public class DirDataexSysTransParam extends AdminAction {
	private static final long serialVersionUID = -3464653131463418344L;
	private static Log log = LogFactory.getLog(DirDataexSysTransParam.class);
	private Integer paramId;
	private String paramName;
	private Page page;
	
	public DirDataexSysTransParam() {
		page = new Page();
		page.setCountField("a.paramId");
	}
	public String adminGo() {
		try {
			QueryCache qc = new QueryCache(" select a.paramId from DataexSysTransParam a " + getWhere() +getOrder());
			setWhere(qc);
			page = qc.page(page);
			page.setResults(QueryCache.idToObj(DataexSysTransParam.class, page.getResults()));
