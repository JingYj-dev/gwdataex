...
public class BootstrapProduceWorkerListener implements ServletContextListener {
	
	private static final Log _logger = LogFactory.getLog(BootstrapProduceWorkerListener.class);
