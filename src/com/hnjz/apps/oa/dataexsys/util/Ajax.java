...
public class Ajax {
	 ...
	 * @return
	 */
 	public static String xmlResult(String code, String description) {
	 ...
	 * @return
	 */
	public static String xmlResult(String code, String description, String content) {
	 ...
	 * @return
	 */
	public static String JSONResult(String code, String description) {
	 ...
	 * @return
	 */
	public static String JSONResult(String code, String description,Object info) {
	...
	@Deprecated
	public static String JSONResult(String code, String description,String info,boolean isJson) {
		StringBuffer buf=new StringBuffer();
		buf.append("{\"result\":\"")
		.append(code)
		.append("\"");
