...
<form class="form-horizontal table-form" name="auditForm" id="auditForm" action="dirAuditLog.action"  onsubmit="return navTabSearch(this)">
		...
		<div class="table-search">
			<ul>
			 ...
			 <ul>
			    ...
			    <li>
			     <ww:button css="btn green" caption="导出" funcode="acl_log/auditLogExport" type="button" onclick="auditLogExport();"></ww:button>
			    </li>
			</ul>
		</div>
	</div>
		...
		<tbody>
		  <ww:iterator value="page.results" id="data" status="index"> 
			<tr ondblclick="javascript:$('#showLogData<ww:property value="#index.getIndex()"/>2').click();">
				...
				<ww:else>
					<td class="text-center iconspage"><span class="expand"><i id="showLogData<ww:property value="#index.getIndex()"/>2" class="icon_arrow_down"></i></span></td>
				</ww:else>
			</tr>
			<tr class="sub">
				<td colspan="10" width="1px;">
