...
<form class="form-horizontal form-validate" id="form1" method="post" name="form1" action="updAuditParam.action" onsubmit="return validateCallback(this, dialogAjaxDone);">
</ww:if>
<ww:else>
<form class="form-horizontal form-validate" id="form1" method="post" name="form1" action="addAuditParam.action" onsubmit="return validateCallback(this, dialogAjaxDone);">
</ww:else>
	...
	<div class="control-group">
	    ...
	    <div class="controls">
	    	<ww:if test="item.paramId == null">
	       		<input type="text" placeholder="请输入参数编号"  class="input-xlarge required digits" name="paramId" id="paramId" onblur="value=this.value.replace(/[^0-9]+/g,'')" onkeyup="value=this.value.replace(/[^0-9]+/g,'')" title="请输入数字" value="<ww:property value='item.paramId'/>"  maxlength="5"  <ww:if test="paramId!= null"></ww:if>> 
	    	</ww:if>
			<ww:else>
	 ...
	 <div class="control-group">
		    ...
		    <div class="controls">
	          <div class="textarea">
		        <textarea   placeholder="" class="input-xlarge" name="paramMemo" id="paramMemo" maxlength="500"><ww:property value='item.paramMemo'/></textarea>
		      </div>
		    </div>
		  </div>
