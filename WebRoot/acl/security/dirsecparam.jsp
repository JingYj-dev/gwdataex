...
<form class="form-horizontal table-form" name="form1" id="form1" method="post" action="dirSecParam.action"  onsubmit="return navTabSearch(this)">
	...
	<div class="table-header">
		<div class="table-search">
			<ul>
			    ...
			    <li>
			    	<ww:button css="btn green" caption="查询" funcode="acl_secparam/dirSecParam" type="submit"></ww:button>
			    </li>
			</ul>
		</div>
		<div class="table-btn">
			<div class="btn-group">
				<ww:link funcode="acl_secparam/addSecParam" css="btn" caption="添加" title="添加参数" target="cssDialog" rel="addSecParam" href="getSecParam.action"></ww:link>
			</div>
			<div class="btn-group">
				<ww:link funcode="acl_secparam/delSecParam" css="btn" caption="批量删除" onclick="$.cssTable.act('delBatch','delSecParam.action');"></ww:link>
			</div>
		</div>
	</div>
		  ...
		  <ww:iterator value="page.results" id="data" status="data">
			<tr>
				...
				<td class="text-center">
					<ww:link funcode="acl_secparam/updSecParam" caption="修改" title="修改参数"target="cssDialog" rel="getDict" href="getSecParam.action?paramId=%{paramId}" ></ww:link>&nbsp;
					<ww:link funcode="acl_secparam/delSecParam" caption="删除" onclick="$.cssTable.act('del','delSecParam.action?ids=%{paramId}')" href="javascript:;"></ww:link>&nbsp;
				</td>
