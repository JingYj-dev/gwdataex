...
<form class="form-horizontal form-validate" id="form1" method="post" name="form1" action="updSecParam.action" onsubmit="return validateCallback(this, dialogAjaxDone);">
</ww:if>
<ww:else>
<form class="form-horizontal form-validate" id="form1" method="post" name="form1" action="addSecParam.action" onsubmit="return validateCallback(this, dialogAjaxDone);">
</ww:else>
