...
<form class="form-horizontal form-validate" id="updTransParam_form" method="post" name="updTransParam_form" action="updDataexSysTransParam.action" onsubmit="return validateCallback(this, dialogAjaxDone);">
</ww:if>
<ww:else>
<form class="form-horizontal form-validate" id="addTransParam_form" method="post" name="addTransParam_form" action="addDataexSysTransParam.action" onsubmit="return validateCallback(this, dialogAjaxDone);">
</ww:else>
	...
	<div class="control-group">
	    ...
	    <div class="controls">
	    	<ww:if test="item.paramId == null or item.paramId == ''">
	       		<input type="text" placeholder="请输入参数编号" onkeyup="value=this.value.replace(/\D+/g,'')" class="input-xlarge required digits" name="paramId" id="paramId" maxlength="5" title="请输入数字" value="<ww:property value='item.paramId'/>"  <ww:if test="paramId != null and paramId != ''"></ww:if>> 
	    	</ww:if>
			<ww:else>
				...
				<input type="text" class="input-xlarge " disabled="disabled" value="<ww:property value='item.paramId'/>" />
			</ww:else>
	    </div>
	  </div>
	  <div class="control-group">
