...
<form class="form-horizontal table-form" name="dataexSysTransParam_form" id="dataexSysTransParam_form" method="post" action="dirDataexSysTransParam.action"  onsubmit="return navTabSearch(this)">
	...
	<div class="table-header">
		<div class="table-search">
			<ul>
			    ...
			    <li>
			    	<ww:button css="btn green" caption="查询" funcode="oa_dataexsys/dirDataexSysTransParam" type="submit"></ww:button>
			    </li>
			</ul>
		</div>
		<div class="table-btn">
			<div class="btn-group">
				<ww:link funcode="oa_dataexsys/addDataexSysTransParam" css="btn" caption="添加" title="添加参数" target="cssDialog" rel="addDataexSysTransParam" href="getDataexSysTransParam.action"></ww:link>
			</div>
			<div class="btn-group">
				<ww:link funcode="oa_dataexsys/delDataexSysTransParam" css="btn" caption="批量删除" onclick="$.cssTable.act('delBatch','delDataexSysTransParam.action');"></ww:link>
			</div>
		</div>
	</div>
		  ...
		  <ww:iterator value="page.results" id="data" status="data">
			<tr>
				...
				<td class="text-center">
					<ww:link funcode="oa_dataexsys/updDataexSysTransParam" caption="修改" title="修改参数" target="cssDialog" rel="getDict" href="getDataexSysTransParam.action?paramId=%{paramId}" ></ww:link>&nbsp;
					<ww:link funcode="oa_dataexsys/delDataexSysTransParam" caption="删除" onclick="$.cssTable.act('del','delDataexSysTransParam.action?ids=%{paramId}')" href="javascript:;"></ww:link>&nbsp;
				</td>
