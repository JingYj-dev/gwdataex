...
<form class="form-horizontal table-form" name="form1" id="form1" method="post" action="dirMsgHistory.action"  onsubmit="return navTabSearch(this)">
	...
	<div class="table-header">
		<div class="table-search">
			<ul>
			    ...
			    <li>
			    	<ww:button css="btn green" caption="查询" funcode="msgcenter_msgspi/dirMsgHistory" type="submit"></ww:button>
			    </li>
			</ul>
		</div>
	</div>
